...
private:
    ...
    void InitializeButtons() {
        ...
        boot_button_.OnDoubleClick([this]() {
            ...
            if (is_first_boot) {
                ESP_LOGI(TAG, "First boot, enable double-click photo feature");
                ...
                ESP_LOGI(TAG, "Non-first boot, disable double-click photo feature");
                auto& app = Application::GetInstance();
    ...
    void InitializeSt7789Display() {
        ...
        // Initialize ST7789 LCD driver chip
    ...
    void InitializeCamera() {
        ...
        config.ledc_channel = LEDC_CHANNEL_2;  // LEDC channel selection for XCLK clock, but S3 does not use
        config.ledc_timer = LEDC_TIMER_2; // LEDC timer selection for XCLK clock, but S3 does not use
        ...
        config.pin_sccb_sda = -1;   // Write -1 to use already initialized I2C interface
