...
#define MON_BTLINK_PIN          GPIO_NUM_4      //DetectBTConnectStatus
#define BOOT_4G5V_PIN           GPIO_NUM_5      //4G模块供电
#define BOOT_4GEN_PIN           GPIO_NUM_6      //4G模块Enable
#define MON_BATT_PIN            GPIO_NUM_43    	//DetectPMUBattery指示
#define MON_BATT_CNT            70    	        //DetectPMUBatterySecond数
#define MON_USB_PIN				GPIO_NUM_47    	//DetectUSB插入
